...
from .models import Member, Meeting, Attendance, Payment, Dashboard
from django.db.models import Sum
...
class PaymentAdmin(admin.ModelAdmin):
    ...
    # 1. Calculate the high-level metrics
    total_approved = Payment.objects.filter(status='approved').aggregate(Sum('amount'))['amount__sum'] or 0
